...
function loadSample(){
  clearAll(); uid=200;
  nodes=[
    {id:'s1',type:'entity',label:'BOOKINGS',x:520,y:330,w:175,h:50,tuples:[
      ...
      {label:'check_in_date',isPK:false,isPartial:false,isFk:false},
      {label:'check_out_date',isPK:false,isPartial:false,isFk:false},
    ...
    {id:'s2',type:'entity',label:'ROOM_TYPES',x:180,y:200,w:165,h:50,tuples:[
      {label:'room_type_id',isPK:true,isPartial:false,isFk:false},
    ...
    {id:'s3',type:'weak_entity',label:'ROOM_UNITS',x:180,y:480,w:165,h:50,tuples:[
      {label:'unit_id',isPK:false,isPartial:true,isFk:false},
      {label:'room_type_id',isPK:false,isPartial:false,isFk:true},
      {label:'unit_number',isPK:false,isPartial:false,isFk:false},
      {label:'status',isPK:false,isPartial:false,isFk:false},
    ]},
    {id:'s4',type:'entity',label:'ADMIN_USERS',x:870,y:200,w:165,h:50,tuples:[
      {label:'id',isPK:true,isPartial:false,isFk:false},
    ...
    {id:'s5',type:'weak_entity',label:'PAYMENTS',x:520,y:600,w:165,h:50,tuples:[
      {label:'id',isPK:true,isPartial:false,isFk:false},
    ...
    {id:'s6',type:'weak_entity',label:'GUESTS',x:870,y:480,w:165,h:50,tuples:[
      {label:'id',isPK:true,isPartial:false,isFk:false},
      {label:'booking_id',isPK:false,isPartial:false,isFk:true},
      {label:'full_name',isPK:false,isPartial:false,isFk:false},
    ...
    {id:'s7',type:'entity',label:'ACTIVITY_LOGS',x:870,y:680,w:165,h:50,tuples:[
      {label:'id',isPK:true,isPartial:false,isFk:false},
    ...
    // relationships
    {id:'r1',type:'relationship',label:'HAS',x:350,y:255,w:110,h:55},
    {id:'r2',type:'id_relationship',label:'ASSIGNED',x:350,y:420,w:120,h:55},
    {id:'r3',type:'id_relationship',label:'HAS',x:690,y:480,w:110,h:55},
    {id:'r4',type:'id_relationship',label:'HAS',x:690,y:330,w:110,h:55},
    {id:'r5',type:'relationship',label:'DELETES',x:690,y:200,w:120,h:55},
    {id:'r6',type:'relationship',label:'GENERATES',x:870,y:580,w:130,h:55},
  ];
  edges=[
